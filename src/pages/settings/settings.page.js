...
const CHEATING_SYSTEMS = [
    ...
    ["joker won't be around", "It's guaranteed that Joker will not be around the card flipped last time. (i.e. joker won't be a neighbor of the last card including diagonals"]
]
